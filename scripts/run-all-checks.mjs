...
const browserFirst = ["battle-smoke", "crew-smoke", "ooc-crew-ui-check", "world-ui-check", "polish-ui-check", "features-ui-check", "world-systems-ui-check", "voyage-ui-check", "empire-ui-check", "duel-ui-check", "events-ui-check", "admin-tools-ui-check", "sovereignty-ui-check", "design-tour"]; // need a clean DB each
