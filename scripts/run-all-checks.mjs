...
const dbChecks = ["island-npc", "canon", "prison-arc", "party-round", "ooc-rollback", "world-arcs", "joint-fight", "guardian", "territory", "escape-buster", "consequence", "black-market", "missions", "grudge", "hunt", "impel", "compaction-travel", "prison-logic", "delete-character", "world-news", "raid", "attributes-inventory", "styles", "coliseum", "voyage", "empire", "duel-resolution", "denden", "battle", "close-fight", "joint-close", "happenings", "player-events", "sovereignty", "reclaim", "admiral-dispatch", "custody", "rescue-raid"];
const browserFirst = ["battle-smoke", "crew-smoke", "ooc-crew-ui-check", "world-ui-check", "polish-ui-check", "features-ui-check", "world-systems-ui-check", "residents-ui-check", "voyage-ui-check", "empire-ui-check", "duel-ui-check", "events-ui-check", "admin-tools-ui-check", "sovereignty-ui-check", "design-tour"]; // need a clean DB each
