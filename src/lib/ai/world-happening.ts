...
export interface HappeningInput {
  islands: { name: string; sea: string; danger: number; control: string | null }[];
...
const SYSTEM =
  ...
  "(2) No entregues frutas del diablo, armas ni objetos concretos a nadie: es una noticia, no un premio. (3) Inventa nombres propios para los personajes nuevos. " +
